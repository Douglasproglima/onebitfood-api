...
review = Review.create!(rate: '0.6', restaurant: r)
...
review = Review.create!(rate: '4.4', restaurant: r)
...
review = Review.create!(rate: '0.2', restaurant: r)
review = Review.create!(rate: '1.8', restaurant: r)
review = Review.create!(rate: '2.9', restaurant: r)
...
r.image.attach(io: File.open(path_image), filename: '5.jpg')
pc = ProductCategory.create!(title: 'Entrada', restaurant: r)
review = Review.create!(rate: '1.2', restaurant: r)
...
pc = ProductCategory.create!(title: 'Entrada', restaurant: r)
review = Review.create!(rate: '2.4', restaurant: r)
review = Review.create!(rate: '4.1', restaurant: r)
